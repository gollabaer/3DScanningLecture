...
private:
	...
	public:
		...
		void nearestNeighbour(Point3d queryPoint, double &currentRange, int &index, std::vector<Point3d> &points);
		std::vector<int> radiusQuery(std::vector<Point3d> &points, Point3d &lowerBoundary, Point3d &upperBoundary, Point3d &queryPoint, double &radius);
	private:
		// Member Variables
